...
func (ec *executionContext) _Query_locations(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Location)
	fc.Result = res
	return ec.marshalNLocation2ᚕᚖgithubᚗcomᚋnewmohrᚋexampleᚋapiᚐLocationᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNLocation2ᚕᚖgithubᚗcomᚋnewmohrᚋexampleᚋapiᚐLocationᚄ(ctx context.Context, sel ast.SelectionSet, v []*Location) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNLocation2ᚖgithubᚗcomᚋnewmohrᚋexampleᚋapiᚐLocation(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNLocation2ᚖgithubᚗcomᚋnewmohrᚋexampleᚋapiᚐLocation(ctx context.Context, sel ast.SelectionSet, v *Location) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
